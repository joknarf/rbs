...
If a server can connect to a host through ssh, the host can connect back to the server using this ssh connection (no ingres ip port to open on server needed)
