...
* Foolish security guys are just preventing you to work properly and don't understand how they are themselces dangerous for system security (breaks/truncates files during vim save/breaks interactive batch dugin run...).
